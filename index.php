...
'เหย' => 'h+#;=j', 'แหย' => 'j+x;+', 'โหย' => 'h+o;=j',
'เอย' => '?+#;=j', 'แอย' => 'j+x;+', 'โอย' => '?+o;=j',
...
//สระเดี่ยว
$Vw = array('ั'=>'+a','ะ'=>'+a','า'=>'+a;','ิ'=>'+i','ี'=>'+i;','ึ'=>'+v','ื'=>'+v;','ุ'=>'+u','ู'=>'+u;','เ'=>'+e;','แ'=>'+x;','ไ'=>'+aj','ใ'=>'+aj','โ'=>'+o;', 'อ'=>'+@;','ัว'=>'+u;a','เา'=>'+aw','เะ'=>'+e','แะ'=>'+x','เิ'=>'+#;','เอ'=>'+#;','โะ'=>'+o','เาะ'=>'+@','เอะ'=>'+#','เีีย'=>'+i;a','เียะ'=>'+ia','เือะ'=>'+va','เือ'=>'+v;a','ัวะ'=>'+ua','ว'=>'+u;a','ัย'=>'+aj','ัม'=>'+am','ำ'=>'+am','็อ'=>'+@');

$Vw2 = array('ัว'=>'+u;a','เา'=>'+aw','เะ'=>'+e','แะ'=>'+x','เอ'=>'+#;','โะ'=>'+o','เาะ'=>'+@','เอะ'=>'+#','เีย'=>'+i;a','เียะ'=>'+ia','เือะ'=>'+va','เือ'=>'+v;a','ัวะ'=>'+ua','เิ'=>'+#;','เ็'=>'+e','แ็'=>'+x','็'=>'+@','ัม' => '+am','็อ'=>'+@');
...
//สระเดี่ยว + ตัวสะกด
$VnCf= array('ะ'=>'+a','า'=>'+a;','ิ'=>'+i','ี'=>'+i;','ึ'=>'+v','ื'=>'+v;','ุ'=>'+u','ู'=>'+u;','เ'=>'+e;','แ'=>'+x;','ไ'=>'+aj','ใ'=>'+aj','โ'=>'+o;','เิ'=>'+#;','ก'=>'+o=k','ข'=>'+o=k','ฃ'=>'+o=k','ค'=>'+o=k','ฅ'=>'+o=k','ฆ'=>'+o=k','ช'=>'+o=d','ฌ'=>'+o=d','ซ'=>'+o=d','ศ'=>'+o=d','ษ'=>'+o=d','ส' =>'+o=d', 'ฎ' =>'+o=d', 'ด' =>'+o=d', 'ฏ' =>'+o=d', 'ต' =>'+o=d','ฐ' =>'+o=d', 'ฑ' =>'+o=d', 'ฒ' =>'+o=d','ถ' =>'+o=d','ท' =>'+o=d', 'ธ' =>'+o=d', 'บ' =>'+o=b', 'ป' =>'+o=b','พ' =>'+o=b','ฟ' =>'+o=b','ง'=>'+o=ng','ญ' =>'+o=n', 'ย'  =>'+o=j','น' =>'+o=n', 'ณ' =>'+o=n', 'ม' =>'+o=m', 'ร' =>'+@;=n' ,'ล' =>'+o=n', 'ฬ' =>'+o=n', 'ว' =>'+o=w', 'อ'=>'+@;','ำ' => '+am','จ'=>'+o=d');
						...
						{			//แบบไม่มีสระหน้า
								...
								else // กรณีที่เป็น อักษรที่ไม่มีสระหน้า  และไม่ควบกล้ำ
								{
	 							 ...
	 							 $ShortV = $thword[1].$thword[2];
									 ...
									 if($ShortV == '็อ')  // ไม้ไต่คู้ และ อ กลายเป็น เอาะ แบบมีตัวสะกด
									 {
								 		//print "4.9<br>";
										$payang= strtr($thword[0],$Cs).strtr($ShortV,$Vw).strtr($thword[3],$Cf);
										$cType = strtr($thword[0],$Triyang);
								 		$vType = strtr($thword[3],$VnT);
								 		$sType = "1";
										//$sType = strtr($thword[1],$Tn);
